...
void atg__fused_rms_norm(raw_tensor *, gc_tensor input, int64_t *normalized_shape_data, int normalized_shape_len, gc_tensor weight, double eps_v, int eps_null);
...
void atg__scaled_dot_product_attention_math_for_mps(raw_tensor *, gc_tensor query, gc_tensor key, gc_tensor value, gc_tensor attn_mask, double dropout_p, int is_causal, gc_tensor dropout_mask, double scale_v, int scale_null, int enable_gqa);
...
void atg_miopen_ctc_loss(raw_tensor *, gc_tensor log_probs, gc_tensor targets, int64_t *input_lengths_data, int input_lengths_len, int64_t *target_lengths_data, int target_lengths_len, int64_t blank, int deterministic, int zero_infinity);
void atg_miopen_ctc_loss_out(raw_tensor *, gc_tensor out0, gc_tensor out1, gc_tensor log_probs, gc_tensor targets, int64_t *input_lengths_data, int input_lengths_len, int64_t *target_lengths_data, int target_lengths_len, int64_t blank, int deterministic, int zero_infinity);
void atg_miopen_ctc_loss_tensor(raw_tensor *, gc_tensor log_probs, gc_tensor targets, gc_tensor input_lengths, gc_tensor target_lengths, int64_t blank, int deterministic, int zero_infinity);
